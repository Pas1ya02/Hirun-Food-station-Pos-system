    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" onclick="pos();" >
              <i class="ni ni-cart text-primary"></i> POS
            </a>
          </li>
          <script>
            function pos() {
              window.location = '/pos/cashier';
            }
          </script>
          <!-- <li class="nav-item">
          ...
          <!-- <li class="nav-item">
            <a class="nav-link" href="productreport.php">
              <i class="fas fa-file-invoice-dollar text-primary"></i> Product
            </a>
          </li> -->
        </ul>
        <!-- Divider -->
        ...
        <ul class="navbar-nav mb-md-3">
          ...
          <li class="nav-item">
            <a class="nav-link" href="productreport.php">
              <i class="ni ni-bullet-list-67"></i>Item Wise Sale 
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="monthreport.php">
              <i class="ni ni-bullet-list-67"></i>Month Sales Product
            </a>
          </li>
        </ul>
        <hr class="my-3">
        <ul class="navbar-nav mb-md-3">
          <li class="nav-item">
            ...
            <i class="ni ni-settings text-danger"></i> Setting
            </a>
          </li>
          <li class="nav-item">
