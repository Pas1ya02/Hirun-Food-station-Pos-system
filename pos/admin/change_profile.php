  ...
  if (!$error) {
    ...
    if (mysqli_num_rows($res) > 0) {
      ...
      if ($old_password != $row['admin_password']) {
        ...
        $new_password  = trim(sha1(md5($_POST['new_password'])));
              ...
              <form method ="post">
                            ...
                            <div class="pl-lg-4">
                              <div class="row">
                                <div class="col-lg-12">
                                  <div class="form-group">
                                    <label class="form-control-label" for="op">Old Password</label>
                                    <input type="password" name="old_password" id="op" class="form-control form-control-alternative">
                                  </div>
                                </div>

                                <div class="col-lg-12">
                                  <div class="form-group">
                                    <label class="form-control-label" for="np">New Password</label>
                                    <input type="password" name="new_password" id="np" class="form-control form-control-alternative">
                                  </div>
                                </div>

                                <div class="col-lg-12">
                                  <div class="form-group">
                                    <label class="form-control-label" for="cnp">Confirm New Password</label>
                                    <input type="password" name="confirm_password" id="cnp" class="form-control form-control-alternative">
                                  </div>
                                </div>

                                <div class="col-lg-12">
                                  <div class="form-group">
                                  <button type="submit" name="changePassword" class="btn btn-success form-control-alternative" >Change Password</button>
                                  </div>
                                </div>
                              </div>
                            </div>
