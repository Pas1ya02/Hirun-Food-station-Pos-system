...
$find = Database::search("SELECT * FROM `rpos_payments` WHERE `order_code`='" . $code . "'");
$find_rs = $find->fetch_assoc();
...
<table class="table align-items-center table-flush">
    ...
    <tbody>
        <?php
            $ret = "SELECT * FROM  `rpos_payments`  WHERE `order_code`='".$code."' ORDER BY `created_at` DESC " ;
